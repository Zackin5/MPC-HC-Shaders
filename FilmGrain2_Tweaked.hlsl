...
#define grainamount 0.04
/*< __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.0; ui_max = 0.2;
	ui_label = "Amount";
> = 0.05;*/

#define coloramount 0.6
/*< __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.0; ui_max = 1.0;
	ui_label = "Color Amount";
> = 0.6;*/

#define lumamount 1.0
/* < __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.0; ui_max = 1.0;
	ui_label = "Luminance Amount";
> = 1.0;*/

#define grainsize 1.6
/*< __UNIFORM_SLIDER_FLOAT1
...
float4 rnm(in float2 tc)
{
	...
	float noise = sin(dot(tc, float2(12.9898, 78.233))) * 43758.543 + timer;
...
float4 main(float2 texCoord : TexCoord) : COLOR
{
	...
	float2 rotCoordsR = coordRot(texCoord, 1);
	...
	if (coloramount > 0)
	{
		float2 rotCoordsG = coordRot(texCoord, 1);
		float2 rotCoordsB = coordRot(texCoord, 1);
